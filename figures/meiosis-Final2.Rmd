...
.libPaths()
.libPaths( c( "\\\\vf-d4-home/d4home$/xfan/MyDocs/R/win-library/4.0" , .libPaths() ) )

setwd("P:/PI/PI_Chuva_de_Sousa_Lopes/susana/Fan xueying/Projects/project-vanessa-meiosis/meiosis-dec/R running/final-June")
outputDir = getwd()
...
FGC <- readRDS("P:/PI/PI_Chuva_de_Sousa_Lopes/susana/Fan xueying/Projects/project-vanessa-meiosis/dataset R running/FGC.rds")
lateMeiot <- readRDS("P:/PI/PI_Chuva_de_Sousa_Lopes/susana/Fan xueying/Projects/project-vanessa-meiosis/dataset R running/lateMeiot.rds")
male <- readRDS("P:/PI/PI_Chuva_de_Sousa_Lopes/susana/Fan xueying/Projects/project-vanessa-meiosis/dataset R running/maleMNN.rds")
...
```{r, echo=TRUE, error=TRUE}
#################Fig.1E####################
marker<- read_excel("Table S1. lateMeiotAllGenesPadj0.05Pct.1_0.6.xls")

disease<- read_excel("Disease.xlsx")



disease.gene <- disease[which(disease$Gene %in% marker$`gene name`),]
...
```{r, echo=TRUE, error=TRUE}
################Fig.3A###################
female.marker<- read_excel("Table S1. lateMeiotAllGenesPadj0.05Pct.1_0.6.xls")
male.marker<- read_excel("Table S2. maleAllGenes_mnn_Padj0.05Pct.1_0.6.xls")
...
L.common <- female.L[which(female.L$`gene name` %in% male.L$`gene name`),]
female.L.specific <- female.L[-which(female.L$`gene name` %in% male.L$`gene name`),]
male.L.specific <- male.L[-which(male.L$`gene name` %in% female.L$`gene name`),]


Z.common <- female.Z[which((female.Z$`gene name` %in% male.Z$`gene name`)&(female.Z$`gene name` %in% male.eP$`gene name`)),]
female.Z.specific <- female.Z[-which((female.Z$`gene name` %in% male.Z$`gene name`)|(female.Z$`gene name` %in% male.eP$`gene name`)),]
male.Z.specific <- male.Z[-which((male.Z$`gene name` %in% female.Z$`gene name`)|(male.Z$`gene name` %in% male.eP$`gene name`)),]
m.ZeP.specific <- male.eP[-which((male.eP$`gene name` %in% female.Z$`gene name`)|(male.eP$`gene name` %in% male.Z$`gene name`)),]

P.common <- female.P[which((female.P$`gene name` %in% male.lP$`gene name`)&(female.P$`gene name` %in% male.eP$`gene name`)),]
m.PeP.specific <- male.eP[-which((male.eP$`gene name` %in% female.P$`gene name`)|(male.eP$`gene name` %in% male.lP$`gene name`)),]
female.P.specific <- female.P[-which((female.P$`gene name` %in% male.lP$`gene name`)|(female.P$`gene name` %in% male.eP$`gene name`)),]
male.lP.specific <- male.lP[-which((male.lP$`gene name` %in% female.P$`gene name`)|(male.lP$`gene name` %in% male.eP$`gene name`)),]

D.common <- female.D[which((female.D$`gene name` %in% male.D$`gene name`)),]
female.D.specific <- female.D[-which((female.D$`gene name` %in% male.D$`gene name`)),]
male.D.specific <- male.D[-which((male.D$`gene name` %in% female.D$`gene name`)),]
...
maleFemaleMeiosisEqualized <- readRDS("femalemale.rds")
...
female.L.LOC <- female.L[grep("LOC", female.L$`gene name`),] 
female.L.LINC <- female.L[grep("LINC", female.L$`gene name`),] 

female.Z.LOC <- female.Z[grep("LOC", female.Z$`gene name`),] 
female.Z.LINC <- female.Z[grep("LINC", female.Z$`gene name`),] 

female.P.LOC <- female.P[grep("LOC", female.P$`gene name`),] 
female.P.LINC <- female.P[grep("LINC", female.P$`gene name`),]

female.D.LOC <- female.D[grep("LOC", female.D$`gene name`),] 
female.D.LINC <- female.D[grep("LINC", female.D$`gene name`),]

male.L.LOC <- male.L[grep("LOC", male.L$`gene name`),] 
male.L.LINC <- male.L[grep("LINC", male.L$`gene name`),]

male.Z.LOC <- male.Z[grep("LOC", male.Z$`gene name`),] 
male.Z.LINC <- male.Z[grep("LINC", male.Z$`gene name`),]

male.eP.LOC <- male.eP[grep("LOC", male.eP$`gene name`),] 
male.eP.LINC <- male.eP[grep("LINC", male.eP$`gene name`),]

male.lP.LOC <- male.lP[grep("LOC", male.lP$`gene name`),] 
male.lP.LINC <- male.lP[grep("LINC", male.lP$`gene name`),]

male.D.LOC <- male.D[grep("LOC", male.D$`gene name`),] 
male.D.LINC <- male.D[grep("LINC", male.D$`gene name`),]
...
Xesc<- read_excel("Eseacpees with reference.new.xlsx")
...
VlnPlot(lateMeiot,features ="XIST", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(lateMeiot,features ="EZH2", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(lateMeiot,features ="SPEN", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(lateMeiot,features ="XACT", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(lateMeiot,features ="TSIX", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(lateMeiot,features ="H2AFY", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
...
VlnPlot(FGC,features ="XIST", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(FGC,features ="EZH2", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(FGC,features ="SPEN", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(FGC,features ="XACT", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(FGC,features ="TSIX", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
VlnPlot(FGC,features ="H2AFY", pt.size = 0)+stat_summary(fun=mean, geom="point", size=2, color="red")+ylim(0,8)
...
chr7.cov5<- read_excel("P:/PI/PI_Chuva_de_Sousa_Lopes/susana/Fan xueying/Projects/project-vanessa-meiosis/meiosis-dec/new/SNPs/05-05-2020/05-05-2020/allele_depth_table_filter_cells_depth_reordered_gene_names_chr7_masked.xls")
chrx.cov5<- read_excel("P:/PI/PI_Chuva_de_Sousa_Lopes/susana/Fan xueying/Projects/project-vanessa-meiosis/meiosis-dec/new/SNPs/05-05-2020/05-05-2020/allele_depth_table_filter_cells_depth_reordered_gene_names_chrX_masked.xls")
...
chrx.cov5 <- read.delim("chrx.cov5-30cells.tsv")
chr7.cov5 <- read.delim("chr7.cov5-30cells.tsv")
...
##
embryox<- read_excel("P:/PI/PI_Chuva_de_Sousa_Lopes/susana/Fan xueying/Projects/project-vanessa-meiosis/meiosis-dec/new/SNPs/05-05-2020/per_embryo_het_calls_cov5_chrX_masked.xls")
embryo7<- read_excel("P:/PI/PI_Chuva_de_Sousa_Lopes/susana/Fan xueying/Projects/project-vanessa-meiosis/meiosis-dec/new/SNPs/05-05-2020/per_embryo_het_calls_cov5_chr7_masked.xls")
...
######################################################
y1 <- df[which(df$variable=="Xproratio"),]
###check normality
shapiro.test(y1$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
kruskal.test(value ~ groupIdentity, data =y1)
pairwise.wilcox.test(y1$value, y1$groupIdentity,
                     p.adjust.method = "BH")

y2 <- df[which(df$variable=="Xescratio"),]
###check normality
shapiro.test(y2$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
kruskal.test(value ~ groupIdentity, data =y2)
pairwise.wilcox.test(y2$value, y2$groupIdentity,
                     p.adjust.method = "BH")

y3 <- df[which(df$variable=="chr7ratio"),]
###check normality
shapiro.test(y3$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
kruskal.test(value ~ groupIdentity, data =y3)
pairwise.wilcox.test(y3$value, y3$groupIdentity,
                     p.adjust.method = "BH")

y3 <- df[which(df$groupIdentity=="F_L"),]
###check normality
shapiro.test(y3$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
kruskal.test(value ~ variable, data =y3)
pairwise.wilcox.test(y3$value, y3$variable,
                     p.adjust.method = "BH")

y3 <- df[which(df$groupIdentity=="F_Z"),]
###check normality
shapiro.test(y3$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
kruskal.test(value ~ variable, data =y3)
...
y3 <- df[which(df$groupIdentity=="F_P"),]
###check normality
shapiro.test(y3$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
kruskal.test(value ~ variable, data =y3)
...
y3 <- df[which(df$groupIdentity=="F_D"),]
###check normality
shapiro.test(y3$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
kruskal.test(value ~ variable, data =y3)
...
y3 <- df[which(df$groupIdentity=="M_L"),]
###check normality
shapiro.test(y3$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
kruskal.test(value ~ variable, data =y3)
...
y3 <- df[which(df$groupIdentity=="M_Z"),]
###check normality
shapiro.test(y3$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
kruskal.test(value ~ variable, data =y3)
...
y3 <- df[which(df$groupIdentity=="M_eP"),]
###check normality
shapiro.test(y3$'value') ##p-value<0.05, data is not normal distribution
###Kruskal Wallis test
